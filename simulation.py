...
def simulate():
    for dt in range(0,nf):
        ...
        for i in range(0,nb):
            ...
            rod_b.append(cylinder(pos=b_com-b_vect/2,axis=b_vect, radius=0.03,color=(42/255, 54/255, 59/255),opacity=0.7,material = materials.wood,scene=scene))
        for i in range(0,ns):
        ...
        for i in range(0,nb*2):
            ...
            nd.append(sphere(pos=n,radius=0.03,color=color.black,scene=scene))
        if dt<nf-1:
